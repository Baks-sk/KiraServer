...
class WebsenderAPI{
	...
	public $timeout = 30;
	public $encodeType = "aes"; // "base64" or "aes"
	// Fixed key and IV for AES (example)
	private $aesKey = "1234567890123456"; // 16 byte
	private $aesIv = "abcdefghijklmnop"; // 16 byte
	...
	private function aesEncrypt($text) {
		return bin2hex(openssl_encrypt($text, 'AES-128-CBC', $this->aesKey, OPENSSL_RAW_DATA, $this->aesIv));
	}
	...
	*/
	...
	$this->writeRawByte(4);
	$this->writeString($this->encode($message));
	return $this->readRawInt() == 1 ? true: false;
	}
